"""
/////////////////////////////////////////////////////////////////////////////////////////
/// Esse código foi inicialmente criado pelo usuário do Stackoverflow 'musicamante' e ///
/// possuidor do repositório dos repositórios no GitHub https://github.com/MaurizioB/ ///
/// Eu, Israel Alves https://github.com/Israelmath, fiz várias alterações para que o  ///
/// Toast funcionasse para mim.                                                       ///
/////////////////////////////////////////////////////////////////////////////////////////
"""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setStyleSheet('''
            QToaster {
                ...
                background-color: ''' + NewColorsPrimary.primary.value + '''
            }
        ''')
        # alternatively:
