...
class Ui_newDashboard(object):
    def setupUi(self, newDashboard):
        ...
        newDashboard.resize(1259, 319)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(newDashboard.sizePolicy().hasHeightForWidth())
        newDashboard.setSizePolicy(sizePolicy)
...
"}")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frCenter.sizePolicy().hasHeightForWidth())
        self.frCenter.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frConteudo.sizePolicy().hasHeightForWidth())
        self.frConteudo.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.stkPrincipal.sizePolicy().hasHeightForWidth())
        self.stkPrincipal.setSizePolicy(sizePolicy)
