...
class Ui_wdgQuizAposentadoria(object):
    def setupUi(self, wdgQuizAposentadoria):
        ...
        wdgQuizAposentadoria.resize(891, 791)
...
"}")
        ...
        self.scrollArea.setMaximumSize(QtCore.QSize(16777215, 12345687))
        ...
        self.scrollCentral.setGeometry(QtCore.QRect(0, 0, 800, 1400))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scrollCentral.sizePolicy().hasHeightForWidth())
        self.scrollCentral.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_2.addWidget(self.frInfo1)
        ...
        self.verticalLayout_2.addWidget(self.frInfo2)
        ...
        self.verticalLayout_2.addWidget(self.frInfo3)
        ...
        self.frAtiv4_2 = QtWidgets.QFrame(self.frAtiv4)
        self.frAtiv4_2.setGeometry(QtCore.QRect(0, 0, 36, 36))
        self.frAtiv4_2.setMinimumSize(QtCore.QSize(36, 36))
        self.frAtiv4_2.setMaximumSize(QtCore.QSize(36, 36))
        self.frAtiv4_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frAtiv4_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frAtiv4_2.setObjectName("frAtiv4_2")
        self.horizontalLayout_5.addWidget(self.frAtiv4)
        self.verticalLayout_2.addWidget(self.frInfo4)
        ...
        self.verticalLayout_2.addWidget(self.frInfo5)
        ...
        self.frAtiv6 = QtWidgets.QFrame(self.frInfo6)
        self.frAtiv6.setMinimumSize(QtCore.QSize(36, 36))
        self.frAtiv6.setMaximumSize(QtCore.QSize(36, 36))
        self.frAtiv6.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frAtiv6.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frAtiv6.setObjectName("frAtiv6")
        self.horizontalLayout_7.addWidget(self.frAtiv6)
        self.verticalLayout_2.addWidget(self.frInfo6)
        ...
        self.verticalLayout_2.addWidget(self.frInfo7)
        ...
        self.verticalLayout_2.addWidget(self.frInfo8)
        ...
        self.verticalLayout_2.addWidget(self.frInfo9)
        ...
        self.verticalLayout_2.addWidget(self.frInfo10)
        ...
        self.verticalLayout_2.addWidget(self.frInfo11)
        ...
        self.verticalLayout_2.addWidget(self.frInfo12)
        ...
        self.verticalLayout_2.addWidget(self.frInfo13)
        ...
        self.verticalLayout_2.addWidget(self.frInfo14)
        ...
        self.verticalLayout_2.addWidget(self.frInfo15)
        ...
        self.verticalLayout_2.addWidget(self.frInfo16)
        self.scrollArea.setWidget(self.scrollCentral)
        self.gridLayout.addWidget(self.scrollArea, 1, 0, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
