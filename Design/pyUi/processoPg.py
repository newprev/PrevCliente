...
"}")
        ...
        self.gridLayout_4 = QtWidgets.QGridLayout(self.frTopBackground)
        self.gridLayout_4.setContentsMargins(16, 4, 16, 8)
        ...
        self.gridLayout_4.addWidget(self.frOrganizadorTop, 1, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.frTitulos, 0, 0, 1, 2)
...
"\n"
"/*----------------------------------------------- Push Buttons -----------------------------------------------*/\n"
"#pbGeral, #pbAposentadorias, \n"
"#pbProcuracao, #pbDocsComp, \n"
"#pbHipo, #pbDecPensionista,  \n"
"#pbRequerimento,  #pbAuxReclusao, \n"
"#pbBeneIdoso,  #pbBeneDeficiente,\n"
"#pbAuxDoenca,  #pbSalMaternidade,\n"
"#pbPensaoMorte, #pbAuxAcidente {\n"
...
"}\n"
"\n"
"#pbGeral:hover, #pbAposentadorias:hover, \n"
"#pbProcuracao:hover, #pbDocsComp:hover, \n"
"#pbHipo:hover, #pbDecPensionista:hover, \n"
"#pbRequerimento:hover, #pbAuxReclusao:hover,\n"
"#pbBeneIdoso:hover, #pbBeneDeficiente:hover,\n"
"#pbAuxDoenca:hover, #pbSalMaternidade:hover,\n"
"#pbPensaoMorte:hover, #pbAuxAcidente:hover {\n"
"    font-family: \"TeX Gyre Adventor\";\n"
"    font-size: 12px;\n"
"    color: lightgrey;\n"
"\n"
...
"}")
        ...
        self.frTituloMenu = QtWidgets.QFrame(self.frGuia)
        self.frTituloMenu.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frTituloMenu.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frTituloMenu.setObjectName("frTituloMenu")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.frTituloMenu)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setSpacing(8)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.frProcessoIcone = QtWidgets.QFrame(self.frTituloMenu)
        ...
        self.lbTituloGuia = QtWidgets.QLabel(self.frTituloMenu)
        self.lbTituloGuia.setObjectName("lbTituloGuia")
        self.horizontalLayout_3.addWidget(self.lbTituloGuia)
        self.verticalLayout.addWidget(self.frTituloMenu)
        ...
        self.pbAposentadorias = QtWidgets.QPushButton(self.frGuia)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout.addWidget(self.pbAposentadorias)
        self.pbAuxAcidente = QtWidgets.QPushButton(self.frGuia)
        self.pbAuxAcidente.setMinimumSize(QtCore.QSize(0, 24))
        self.pbAuxAcidente.setObjectName("pbAuxAcidente")
        self.verticalLayout.addWidget(self.pbAuxAcidente)
        self.pbAuxDoenca = QtWidgets.QPushButton(self.frGuia)
        self.pbAuxDoenca.setMinimumSize(QtCore.QSize(0, 24))
        self.pbAuxDoenca.setObjectName("pbAuxDoenca")
        self.verticalLayout.addWidget(self.pbAuxDoenca)
        self.pbAuxReclusao = QtWidgets.QPushButton(self.frGuia)
        self.pbAuxReclusao.setMinimumSize(QtCore.QSize(0, 24))
        self.pbAuxReclusao.setObjectName("pbAuxReclusao")
        self.verticalLayout.addWidget(self.pbAuxReclusao)
        self.pbBeneDeficiente = QtWidgets.QPushButton(self.frGuia)
        self.pbBeneDeficiente.setMinimumSize(QtCore.QSize(0, 24))
        self.pbBeneDeficiente.setObjectName("pbBeneDeficiente")
        self.verticalLayout.addWidget(self.pbBeneDeficiente)
        self.pbBeneIdoso = QtWidgets.QPushButton(self.frGuia)
        self.pbBeneIdoso.setMinimumSize(QtCore.QSize(0, 24))
        self.pbBeneIdoso.setObjectName("pbBeneIdoso")
        self.verticalLayout.addWidget(self.pbBeneIdoso)
        self.pbSalMaternidade = QtWidgets.QPushButton(self.frGuia)
        self.pbSalMaternidade.setMinimumSize(QtCore.QSize(0, 24))
        self.pbSalMaternidade.setObjectName("pbSalMaternidade")
        self.verticalLayout.addWidget(self.pbSalMaternidade)
        self.pbPensaoMorte = QtWidgets.QPushButton(self.frGuia)
        self.pbPensaoMorte.setMinimumSize(QtCore.QSize(0, 24))
        self.pbPensaoMorte.setObjectName("pbPensaoMorte")
        self.verticalLayout.addWidget(self.pbPensaoMorte)
        ...
        self.pbDecPensionista = QtWidgets.QPushButton(self.frGuia)
        self.pbDecPensionista.setMinimumSize(QtCore.QSize(0, 24))
        self.pbDecPensionista.setObjectName("pbDecPensionista")
        self.verticalLayout.addWidget(self.pbDecPensionista)
        self.pbRequerimento = QtWidgets.QPushButton(self.frGuia)
        self.pbRequerimento.setMinimumSize(QtCore.QSize(0, 24))
        self.pbRequerimento.setObjectName("pbRequerimento")
        self.verticalLayout.addWidget(self.pbRequerimento)
    ...
    def retranslateUi(self, mwProcessoPage):
        ...
        self.lbInfoAposentadoria.setText(_translate("mwProcessoPage", "Benefícios"))
        self.pbAposentadorias.setText(_translate("mwProcessoPage", "Aposentadorias"))
        self.pbAuxAcidente.setText(_translate("mwProcessoPage", "Auxílio acidente"))
        self.pbAuxDoenca.setText(_translate("mwProcessoPage", "Auxílio doença"))
        self.pbAuxReclusao.setText(_translate("mwProcessoPage", "Auxílio reclusão"))
        self.pbBeneDeficiente.setText(_translate("mwProcessoPage", "Benefício ao deficiente"))
        self.pbBeneIdoso.setText(_translate("mwProcessoPage", "Benefício ao idoso"))
        self.pbSalMaternidade.setText(_translate("mwProcessoPage", "Salário maternidade"))
        self.pbPensaoMorte.setText(_translate("mwProcessoPage", "Pensão por morte"))
        ...
        self.pbDecPensionista.setText(_translate("mwProcessoPage", "Dec. Pensionista"))
        self.pbRequerimento.setText(_translate("mwProcessoPage", "Requerimento"))
