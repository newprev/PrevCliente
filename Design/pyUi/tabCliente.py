...
class Ui_wdgTabCliente(object):
    def setupUi(self, wdgTabCliente):
        ...
        wdgTabCliente.setMinimumSize(QtCore.QSize(945, 560))
...
"}")
        ...
        self.frFiltrosBusca.setGeometry(QtCore.QRect(0, 0, 211, 510))
        ...
        self.frFiltrosBusca.setMinimumSize(QtCore.QSize(0, 510))
        self.frFiltrosBusca.setMaximumSize(QtCore.QSize(16777215, 500))
        ...
        self.tblClientes.setGeometry(QtCore.QRect(230, 130, 921, 360))
        ...
        self.tabCadastro.setMinimumSize(QtCore.QSize(0, 560))
        font = QtGui.QFont()
        font.setFamily("TeX Gyre Adventor")
        font.setPointSize(-1)
...
"}")
        ...
        self.scrollArea.setGeometry(QtCore.QRect(-1, 0, 991, 521))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scaCadastro = QtWidgets.QWidget()
        self.scaCadastro.setGeometry(QtCore.QRect(0, 0, 989, 519))
        self.scaCadastro.setObjectName("scaCadastro")
        self.pbCarregaCnis = QtWidgets.QPushButton(self.scaCadastro)
        self.pbCarregaCnis.setGeometry(QtCore.QRect(780, 467, 101, 41))
        self.pbCarregaCnis.setObjectName("pbCarregaCnis")
        self.frInfoPessoais = QtWidgets.QFrame(self.scaCadastro)
        self.frInfoPessoais.setGeometry(QtCore.QRect(10, 80, 360, 431))
        self.frInfoPessoais.setMinimumSize(QtCore.QSize(360, 420))
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(self.frInfoPessoais)
        ...
        self.rbMasculino = QtWidgets.QRadioButton(self.frame)
        self.rbMasculino.setGeometry(QtCore.QRect(250, 20, 91, 23))
        self.rbMasculino.setObjectName("rbMasculino")
        self.cbClienteAntigo = QtWidgets.QCheckBox(self.frame)
        self.cbClienteAntigo.setGeometry(QtCore.QRect(90, 30, 111, 23))
        self.cbClienteAntigo.setObjectName("cbClienteAntigo")
        self.rbFeminino = QtWidgets.QRadioButton(self.frame)
        self.rbFeminino.setGeometry(QtCore.QRect(250, 40, 91, 23))
        self.rbFeminino.setObjectName("rbFeminino")
        self.sbCdCliente = QtWidgets.QSpinBox(self.frame)
        self.sbCdCliente.setGeometry(QtCore.QRect(10, 30, 61, 26))
        self.sbCdCliente.setMaximum(1000)
        self.sbCdCliente.setObjectName("sbCdCliente")
        self.lbCdCliente = QtWidgets.QLabel(self.frame)
        self.lbCdCliente.setGeometry(QtCore.QRect(10, 10, 81, 17))
        self.lbCdCliente.setObjectName("lbCdCliente")
        self.verticalLayout.addWidget(self.frame)
        self.frame_2 = QtWidgets.QFrame(self.frInfoPessoais)
        self.frame_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.lbSobrenome = QtWidgets.QLabel(self.frame_2)
        self.lbSobrenome.setGeometry(QtCore.QRect(150, 10, 91, 17))
        self.lbSobrenome.setObjectName("lbSobrenome")
        self.lbCpf = QtWidgets.QLabel(self.frame_2)
        self.lbCpf.setGeometry(QtCore.QRect(10, 130, 64, 17))
        self.lbCpf.setObjectName("lbCpf")
        self.leTelefone = QtWidgets.QLineEdit(self.frame_2)
        self.leTelefone.setGeometry(QtCore.QRect(10, 270, 121, 25))
        self.leTelefone.setMaxLength(16)
        self.leTelefone.setObjectName("leTelefone")
        self.lbEstCivil = QtWidgets.QLabel(self.frame_2)
        self.lbEstCivil.setGeometry(QtCore.QRect(10, 190, 91, 17))
        self.lbEstCivil.setObjectName("lbEstCivil")
        self.lbTelefone = QtWidgets.QLabel(self.frame_2)
        self.lbTelefone.setGeometry(QtCore.QRect(10, 250, 101, 17))
        self.lbTelefone.setObjectName("lbTelefone")
        self.lbIdade = QtWidgets.QLabel(self.frame_2)
        self.lbIdade.setGeometry(QtCore.QRect(300, 70, 51, 17))
        self.lbIdade.setObjectName("lbIdade")
        self.lbNome = QtWidgets.QLabel(self.frame_2)
        self.lbNome.setGeometry(QtCore.QRect(10, 10, 101, 17))
        self.lbNome.setObjectName("lbNome")
        self.lbEstCivil_2 = QtWidgets.QLabel(self.frame_2)
        self.lbEstCivil_2.setGeometry(QtCore.QRect(150, 250, 191, 17))
        self.lbEstCivil_2.setObjectName("lbEstCivil_2")
        self.pbMaisTelefones = QtWidgets.QPushButton(self.frame_2)
        self.pbMaisTelefones.setGeometry(QtCore.QRect(10, 310, 121, 25))
        self.pbMaisTelefones.setObjectName("pbMaisTelefones")
        self.lbRg = QtWidgets.QLabel(self.frame_2)
        self.lbRg.setGeometry(QtCore.QRect(10, 70, 64, 17))
        self.lbRg.setObjectName("lbRg")
        self.cbxEscolaridade = QtWidgets.QComboBox(self.frame_2)
        self.cbxEscolaridade.setGeometry(QtCore.QRect(150, 270, 191, 25))
        self.cbxEscolaridade.setObjectName("cbxEscolaridade")
        self.leEmail = QtWidgets.QLineEdit(self.frame_2)
        self.leEmail.setGeometry(QtCore.QRect(150, 210, 191, 25))
        self.leEmail.setMaxLength(40)
        self.leEmail.setObjectName("leEmail")
        self.leIdade = QtWidgets.QLineEdit(self.frame_2)
        self.leIdade.setGeometry(QtCore.QRect(300, 90, 41, 25))
        self.leIdade.setMaxLength(2)
        self.leIdade.setObjectName("leIdade")
        self.lbNomeMae = QtWidgets.QLabel(self.frame_2)
        self.lbNomeMae.setGeometry(QtCore.QRect(150, 130, 101, 17))
        self.lbNomeMae.setObjectName("lbNomeMae")
        self.leRg = QtWidgets.QLineEdit(self.frame_2)
        self.leRg.setGeometry(QtCore.QRect(10, 90, 121, 25))
        self.leRg.setMaxLength(12)
        self.leRg.setObjectName("leRg")
        self.leCpf = QtWidgets.QLineEdit(self.frame_2)
        self.leCpf.setGeometry(QtCore.QRect(10, 150, 113, 25))
        self.leCpf.setMaxLength(14)
        self.leCpf.setFrame(True)
        self.leCpf.setObjectName("leCpf")
        self.cbxEstCivil = QtWidgets.QComboBox(self.frame_2)
        self.cbxEstCivil.setGeometry(QtCore.QRect(10, 210, 121, 25))
        self.cbxEstCivil.setObjectName("cbxEstCivil")
        self.dtNascimento = QtWidgets.QDateEdit(self.frame_2)
        self.dtNascimento.setGeometry(QtCore.QRect(150, 90, 131, 26))
        self.dtNascimento.setCalendarPopup(True)
        self.dtNascimento.setObjectName("dtNascimento")
        self.lbEmail = QtWidgets.QLabel(self.frame_2)
        self.lbEmail.setGeometry(QtCore.QRect(150, 190, 101, 17))
        self.lbEmail.setObjectName("lbEmail")
        self.lePrimeiroNome = QtWidgets.QLineEdit(self.frame_2)
        self.lePrimeiroNome.setGeometry(QtCore.QRect(10, 30, 121, 25))
        self.lePrimeiroNome.setMaxLength(20)
        self.lePrimeiroNome.setObjectName("lePrimeiroNome")
        self.leNomeMae = QtWidgets.QLineEdit(self.frame_2)
        self.leNomeMae.setGeometry(QtCore.QRect(150, 150, 191, 25))
        self.leNomeMae.setMaxLength(40)
        self.leNomeMae.setObjectName("leNomeMae")
        self.lbDataNascimento = QtWidgets.QLabel(self.frame_2)
        self.lbDataNascimento.setGeometry(QtCore.QRect(150, 70, 121, 17))
        self.lbDataNascimento.setObjectName("lbDataNascimento")
        self.leSobrenome = QtWidgets.QLineEdit(self.frame_2)
        self.leSobrenome.setGeometry(QtCore.QRect(150, 30, 191, 25))
        ...
        self.frInfoResidencial.setGeometry(QtCore.QRect(390, 80, 361, 251))
        ...
        self.frInfoProfissional.setGeometry(QtCore.QRect(390, 350, 361, 161))
        ...
        self.pbLimpar.setGeometry(QtCore.QRect(780, 387, 201, 25))
        self.pbLimpar.setObjectName("pbLimpar")
        self.lbFrTituloInfoProfissional = QtWidgets.QLabel(self.scaCadastro)
        self.lbFrTituloInfoProfissional.setGeometry(QtCore.QRect(410, 340, 171, 17))
        ...
        self.pbAtualizar.setGeometry(QtCore.QRect(780, 347, 201, 25))
        ...
        self.frInfoBancarias.setGeometry(QtCore.QRect(760, 80, 221, 251))
        ...
        self.leNomeBanco.setGeometry(QtCore.QRect(10, 30, 161, 25))
        ...
        self.lbNomeBanco.setGeometry(QtCore.QRect(10, 10, 141, 17))
        self.lbNomeBanco.setObjectName("lbNomeBanco")
        self.leNumeroAgencia = QtWidgets.QLineEdit(self.frInfoBancarias)
        self.leNumeroAgencia.setGeometry(QtCore.QRect(10, 90, 71, 25))
        ...
        self.leSenhaINSS.setGeometry(QtCore.QRect(10, 210, 161, 25))
