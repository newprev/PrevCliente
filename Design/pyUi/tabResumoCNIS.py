...
"")
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tblCalculos.sizePolicy().hasHeightForWidth())
        self.tblCalculos.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_2.addWidget(self.tblCalculos, 2, 0, 1, 2)
