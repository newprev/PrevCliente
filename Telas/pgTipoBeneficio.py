...
# Form implementation generated from reading ui file 'pgTipoBeneficio.ui'
#
...
class Ui_wdgTipoBeneficio(object):
    def setupUi(self, wdgTipoBeneficio):
        wdgTipoBeneficio.setObjectName("wdgTipoBeneficio")
        wdgTipoBeneficio.resize(891, 655)
        wdgTipoBeneficio.setStyleSheet("/* ------------------------------ Widgets ------------------------------ */\n"
"#wdgNatureza{\n"
...
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(wdgTipoBeneficio)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frMain = QtWidgets.QFrame(wdgTipoBeneficio)
        ...
        self.retranslateUi(wdgTipoBeneficio)
        QtCore.QMetaObject.connectSlotsByName(wdgTipoBeneficio)

    def retranslateUi(self, wdgTipoBeneficio):
        _translate = QtCore.QCoreApplication.translate
        wdgTipoBeneficio.setWindowTitle(_translate("wdgTipoBeneficio", "Form"))
        self.lbTituloNatureza.setText(_translate("wdgTipoBeneficio", "Escolha o tipo de benefício"))
        self.pbApos.setText(_translate("wdgTipoBeneficio", "Aposentadoria"))
        self.pbAuxReclusao.setText(_translate("wdgTipoBeneficio", "Auxílio \n"
"reclusão"))
        self.pbAposDeficiencia.setText(_translate("wdgTipoBeneficio", "Aposentadoria da pessoa \n"
"com deficiência"))
        self.pbBeneIdoso.setText(_translate("wdgTipoBeneficio", "Benefício assistencial \n"
"ao idoso"))
        self.pbAposRural.setText(_translate("wdgTipoBeneficio", "Aposentadoria \n"
"rural"))
        self.pbAposEspecial.setText(_translate("wdgTipoBeneficio", "Aposentadoria \n"
"especial"))
        self.pbBeneDeficiencia.setText(_translate("wdgTipoBeneficio", "Benefício assistencial à \n"
"pessoa com deficiência"))
        self.pbPensaoMorte.setText(_translate("wdgTipoBeneficio", "Pensão por morte"))
        self.pbAuxilioDoenca.setText(_translate("wdgTipoBeneficio", "Auxílio \n"
"doença"))
        self.pbSalMaternidade.setText(_translate("wdgTipoBeneficio", "Salário maternidade"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    wdgTipoBeneficio = QtWidgets.QWidget()
    ui = Ui_wdgTipoBeneficio()
    ui.setupUi(wdgTipoBeneficio)
    wdgTipoBeneficio.show()
    sys.exit(app.exec_())
