...
# Form implementation generated from reading ui file 'pgTipoProcesso.ui'
#
...
class Ui_wdgTipoProcesso(object):
    def setupUi(self, wdgTipoProcesso):
        wdgTipoProcesso.setObjectName("wdgTipoProcesso")
        wdgTipoProcesso.resize(891, 655)
        wdgTipoProcesso.setStyleSheet("/* ------------------------------ Widgets ------------------------------ */\n"
"#wdgNatureza{\n"
...
"    color: white;    \n"
"}")
        self.verticalLayout = QtWidgets.QVBoxLayout(wdgTipoProcesso)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frMain = QtWidgets.QFrame(wdgTipoProcesso)
        ...
        self.retranslateUi(wdgTipoProcesso)
        QtCore.QMetaObject.connectSlotsByName(wdgTipoProcesso)

    def retranslateUi(self, wdgTipoProcesso):
        _translate = QtCore.QCoreApplication.translate
        wdgTipoProcesso.setWindowTitle(_translate("wdgTipoProcesso", "Form"))
        self.lbTituloNatureza.setText(_translate("wdgTipoProcesso", "Escolha o tipo de processo"))
        self.pbConcessao.setText(_translate("wdgTipoProcesso", "Concessão"))
        self.pbRevisao.setText(_translate("wdgTipoProcesso", "Revisão"))
        self.pbRecursoOrdinario.setText(_translate("wdgTipoProcesso", "Recurso \n"
"Ordinário"))
        self.pbRecursoEspecial.setText(_translate("wdgTipoProcesso", "Recurso \n"
"Especial"))
...
if __name__ == "__main__":
    ...
    wdgTipoProcesso = QtWidgets.QWidget()
    ui = Ui_wdgTipoProcesso()
    ui.setupUi(wdgTipoProcesso)
    wdgTipoProcesso.show()
    sys.exit(app.exec_())
