...
def inserindoIndiceAtuMonetaria(*args, **kwargs):
    info(f'{TipoLog.DataBase.value}::inserindoIndiceAtuMonetaria___________________{TABLENAME}')


@pre_delete(sender=IndiceAtuMonetaria)
def deletandoIndiceAtuMonetaria(*args, **kwargs):
    info(f'{TipoLog.DataBase.value}::deletandoIndiceAtuMonetaria___________________{TABLENAME}')
